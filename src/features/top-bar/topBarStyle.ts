...
export const topBarStyle: TopBarStyle = {
  ...
  '--km-topbar-title-eyebrow-weight': String(topBarTokens.titleEyebrowWeight),
  '--km-topbar-title-eyebrow-letter-spacing': topBarTokens.titleEyebrowTracking,
  ...
  '--km-topbar-search-label-weight': String(topBarTokens.searchLabelWeight),
  '--km-topbar-search-label-letter-spacing': topBarTokens.searchLabelTracking,
  '--km-topbar-search-shadow': topBarTokens.searchShadow,
  ...
  '--km-topbar-status-border-color': topBarTokens.statusBorderColor,
  '--km-topbar-status-radius': `${topBarTokens.statusRadius}px`,
  '--km-topbar-status-bg': topBarTokens.statusBackground,
  '--km-topbar-status-shadow': topBarTokens.statusShadow,
  ...
  '--km-topbar-status-value-weight': String(topBarTokens.statusValueWeight),
  '--km-topbar-status-dot': `${topBarTokens.statusDotSize}px`,
  '--km-topbar-status-dot-gap': `${topBarTokens.statusDotGap}px`,
  '--km-topbar-status-dot-bg': topBarTokens.statusDotBackground,
}
