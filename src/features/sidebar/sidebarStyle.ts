...
export const sidebarStyle: SidebarStyle = {
  ...
  '--km-sidebar-brand-weight': String(sidebarTokens.brandMarkWeight),
  ...
  '--km-sidebar-nav-label-weight': String(sidebarTokens.navLabelWeight),
  '--km-sidebar-nav-label-letter-spacing': sidebarTokens.navLabelTracking,
