use super::fixtures::{chunk, closed_chunk, integration};

#[test]
fn report_aggregates_multiple_successful_inputs() -> Result<(), String> {
    let first = [0.0, 0.1];
    let second = [0.2, 0.3];
...
#[test]
fn partial_write_propagates_compact_counts() -> Result<(), String> {
