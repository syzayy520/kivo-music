...
const PRODUCTION_FILES: &[&str] = &[
    "src/playback/audio_route/pipeline_tap/mod.rs",
    "src/playback/audio_route/pipeline_tap/config.rs",
    "src/playback/audio_route/pipeline_tap/tap.rs",
    "src/playback/audio_route/pipeline_tap/error.rs",
    "src/playback/audio_route/pipeline_tap/report.rs",
    "src/playback/audio_route/pipeline_tap/mapping.rs",
    "src/playback/audio_route/pipeline_tap/frame_kind.rs",
    "src/playback/native_pipeline/route_tap.rs",
];

const TEST_FILES: &[&str] = &[
    "src/playback/audio_route/pipeline_tap/tests/mod.rs",
    "src/playback/audio_route/pipeline_tap/tests/fixtures.rs",
    "src/playback/audio_route/pipeline_tap/tests/tap_tests.rs",
    "src/playback/audio_route/pipeline_tap/tests/backpressure_tests.rs",
    "src/playback/audio_route/pipeline_tap/tests/failure_isolation_tests.rs",
    "src/playback/audio_route/pipeline_tap/tests/report_tests.rs",
    "src/playback/audio_route/pipeline_tap/tests/structure_tests.rs",
...
fn root_file_is_thin_exports_only() -> Result<(), String> {
    let text = read_repo_file("src/playback/audio_route/pipeline_tap/mod.rs")?;
