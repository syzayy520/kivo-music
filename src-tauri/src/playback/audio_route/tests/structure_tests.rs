...
const PROD_FILES: &[&str] = &[
    "src/playback/audio_route/mod.rs",
...
const TEST_FILES: &[&str] = &[
    "src/playback/audio_route/tests/mod.rs",
    "src/playback/audio_route/tests/fixtures.rs",
    "src/playback/audio_route/tests/owner_tests.rs",
    "src/playback/audio_route/tests/feed_tests.rs",
    "src/playback/audio_route/tests/format_tests.rs",
    "src/playback/audio_route/tests/backpressure_tests.rs",
    "src/playback/audio_route/tests/lifecycle_tests.rs",
    "src/playback/audio_route/tests/report_tests.rs",
    "src/playback/audio_route/tests/structure_tests.rs",
];
...
fn route_root_is_thin_exports_only() -> Result<(), String> {
    let text = read_repo_file("src/playback/audio_route/mod.rs")?;
