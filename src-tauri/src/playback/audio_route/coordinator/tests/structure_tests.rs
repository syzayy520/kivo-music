...
const PRODUCTION_FILES: &[&str] = &[
    "src/playback/audio_route/coordinator/mod.rs",
    "src/playback/audio_route/coordinator/config.rs",
    "src/playback/audio_route/coordinator/facade.rs",
    "src/playback/audio_route/coordinator/error.rs",
    "src/playback/audio_route/coordinator/report.rs",
    "src/playback/audio_route/coordinator/state.rs",
    "src/playback/audio_route/coordinator/mapping.rs",
];

const TEST_FILES: &[&str] = &[
    "src/playback/audio_route/coordinator/tests/mod.rs",
    "src/playback/audio_route/coordinator/tests/fixtures.rs",
    "src/playback/audio_route/coordinator/tests/init_tests.rs",
    "src/playback/audio_route/coordinator/tests/feed_tests.rs",
    "src/playback/audio_route/coordinator/tests/lifecycle_tests.rs",
    "src/playback/audio_route/coordinator/tests/report_tests.rs",
    "src/playback/audio_route/coordinator/tests/error_tests.rs",
    "src/playback/audio_route/coordinator/tests/structure_tests.rs",
];
...
fn root_file_is_thin_exports_only() -> Result<(), String> {
    let text = read_repo_file("src/playback/audio_route/coordinator/mod.rs")?;
