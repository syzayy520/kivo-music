...
//
// Builder methods for prerequisite failure cases in start/stop smoke reports.
//
// These builders handle cases where the smoke probe failed during
// endpoint activation, mix format retrieval, audio client initialization,
// or render client service acquisition.
