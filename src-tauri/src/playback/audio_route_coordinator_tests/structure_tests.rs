...
const PRODUCTION_FILES: &[&str] = &[
    "src/playback/audio_route_coordinator.rs",
    "src/playback/audio_route_coordinator/config.rs",
    "src/playback/audio_route_coordinator/coordinator.rs",
    "src/playback/audio_route_coordinator/error.rs",
    "src/playback/audio_route_coordinator/report.rs",
    "src/playback/audio_route_coordinator/state.rs",
    "src/playback/audio_route_coordinator/mapping.rs",
];

const TEST_FILES: &[&str] = &[
    "src/playback/audio_route_coordinator_tests.rs",
    "src/playback/audio_route_coordinator_tests/fixtures.rs",
    "src/playback/audio_route_coordinator_tests/init_tests.rs",
    "src/playback/audio_route_coordinator_tests/feed_tests.rs",
    "src/playback/audio_route_coordinator_tests/lifecycle_tests.rs",
    "src/playback/audio_route_coordinator_tests/report_tests.rs",
    "src/playback/audio_route_coordinator_tests/error_tests.rs",
    "src/playback/audio_route_coordinator_tests/structure_tests.rs",
];
...
fn root_file_is_thin_exports_only() -> Result<(), String> {
    let text = read_repo_file("src/playback/audio_route_coordinator.rs")?;
