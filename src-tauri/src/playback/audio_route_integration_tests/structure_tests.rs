...
const PRODUCTION_FILES: &[&str] = &[
    "src/playback/audio_route_integration.rs",
    "src/playback/audio_route_integration/config.rs",
    "src/playback/audio_route_integration/facade.rs",
    "src/playback/audio_route_integration/error.rs",
    "src/playback/audio_route_integration/report.rs",
    "src/playback/audio_route_integration/mapping.rs",
    "src/playback/audio_route_integration/frame_input.rs",
    "src/playback/audio_route_integration/state.rs",
];

const TEST_FILES: &[&str] = &[
    "src/playback/audio_route_integration_tests.rs",
    "src/playback/audio_route_integration_tests/fixtures.rs",
    "src/playback/audio_route_integration_tests/init_tests.rs",
    "src/playback/audio_route_integration_tests/feed_tests.rs",
    "src/playback/audio_route_integration_tests/lifecycle_tests.rs",
    "src/playback/audio_route_integration_tests/report_tests.rs",
    "src/playback/audio_route_integration_tests/error_tests.rs",
    "src/playback/audio_route_integration_tests/structure_tests.rs",
];
...
fn root_file_is_thin_exports_only() -> Result<(), String> {
    let text = read_repo_file("src/playback/audio_route_integration.rs")?;
