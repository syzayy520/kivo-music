...
pub(super) fn config(capacity_frames: u32) -> AudioRouteIntegrationConfig {
    AudioRouteIntegrationConfig {
        coordinator: AudioRouteCoordinatorConfig {
...
pub(super) fn integration(
    capacity_frames: u32,
) -> Result<AudioRouteIntegration, AudioRouteIntegrationError> {
    AudioRouteIntegration::new(config(capacity_frames))
}
