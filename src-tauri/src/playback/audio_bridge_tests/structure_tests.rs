...
const TEST_FILES: &[&str] = &[
    "src/playback/audio_bridge_tests.rs",
    "src/playback/audio_bridge_tests/fixtures.rs",
    "src/playback/audio_bridge_tests/format_tests.rs",
    "src/playback/audio_bridge_tests/write_tests.rs",
    "src/playback/audio_bridge_tests/partial_write_tests.rs",
    "src/playback/audio_bridge_tests/backpressure_tests.rs",
    "src/playback/audio_bridge_tests/error_tests.rs",
    "src/playback/audio_bridge_tests/report_tests.rs",
    "src/playback/audio_bridge_tests/structure_tests.rs",
];
