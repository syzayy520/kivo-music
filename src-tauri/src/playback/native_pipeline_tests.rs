...
fn map_worker_state_does_not_mutate_pipeline_snapshot() {
    ...
    assert_eq!(before.decoder_request.is_none(), after.decoder_request.is_none());
    assert_eq!(before.output_status.pending_frames, after.output_status.pending_frames);
